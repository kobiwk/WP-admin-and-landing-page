   ...
   /**
     ...
     */
     ...
     file_frame.on('insert', function() {
      ...
      $( '#featured-header-logo-container' )
          .children( 'img ')
            .attr( 'src', json.url )
          ...
          $( '#header-logo-src' ).val( json.url );
          $( '#header-logo-title' ).val(json.title);
          $( '#header-logo-alt' ).val(json.caption);
 ...
 */
 ...
 function resetUploadFormHeaderLogo( $ ) {
  'use strict';
  ...
  //Reset the meta data input
    $( '#featured-header-logo-info' )
      .children()
      .val( '' ); 
 }

function renderFeaturedHeaderLogo( $ ) {
  if ('' !== $.trim( $('#header-logo-src').val() ) ) {
    $('#featured-header-logo-container').removeClass('hidden');
 ...
 (function( $ ) {
  ...
  $(function() {
    ...
    renderFeaturedHeaderLogo( $ );
          
    
    $( '#set-header-logo' ).on('click', function( evt ) {
      //Stop the anchor's default behavior
      evt.preventDefault();

      //Display the media uploader
      renderMediaUploaderHeaderLogo($);
    });
          

    $( '#remove-header-logo').on('click', function( evt ){
        evt.preventDefault();

        resetUploadFormHeaderLogo( $ );
